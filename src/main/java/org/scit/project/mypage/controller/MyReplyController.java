...
import org.scit.project.mypage.service.MyReplyService;
...
public class MyReplyController {
    ...
    public String reply(@AuthenticationPrincipal UserDetails userDetails, 
    	...
    	Page<MyReplyDTO> replies = (Page<MyReplyDTO>) myReplyService.getMyReplies(userSeq, page, pageSize);
    	...
    	model.addAttribute("replies", replies.isEmpty() ? Collections.emptyList() : replies.getContent());
